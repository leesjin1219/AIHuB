...
def main():
    data_root = r'C:\Users\user\Desktop\AIHub data zip\1. casting_defective_labelled'
    save_root = r'C:\Users\user\Desktop\AIHub data zip\1. casting_defective_labelled_split'
