...
def main():
    ...
    train_root = r'C:\Users\user\Desktop\AIHub data zip\1. casting_defective_labelled_split\train'
    train_dataset = CustomDataset(train_root)
    train_loader = DataLoader(dataset=train_dataset, batch_size=batch_size, shuffle=True)

    valid_root = r'C:\Users\user\Desktop\AIHub data zip\1. casting_defective_labelled_split\valid'
